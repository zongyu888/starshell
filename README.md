...
```bash
# 下载安装包
https://github.com/zongyu888/starshell/releases/download/v1.0.0/StarShell-Setup-1.0.0.exe
...
```bash
# 下载 DMG 文件
https://github.com/zongyu888/starshell/releases/download/v1.0.0/StarShell-1.0.0.dmg

# 双击 DMG 文件，将 StarShell 拖到 Applications 文件夹
```

#### Linux 用户
```bash
# 下载 AppImage 文件
wget https://github.com/zongyu888/starshell/releases/download/v1.0.0/StarShell-1.0.0.AppImage

# 添加执行权限
chmod +x StarShell-1.0.0.AppImage

# 运行
./StarShell-1.0.0.AppImage
```
